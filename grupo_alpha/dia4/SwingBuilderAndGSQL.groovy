...
def sql = groovy.sql.Sql.newInstance("jdbc:hsqldb:file:dbAsembly","sa","","org.hsqldb.jdbcDriver")
// Una consulta a cualquier tabla
def consulta = "Select * from cliente"
def clientTable = "create table cliente(id integer primary key, nombre varchar(255))"
